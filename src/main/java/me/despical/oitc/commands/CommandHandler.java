...
import me.despical.oitc.commands.admin.*;
import me.despical.oitc.commands.player.*;
...
public class CommandHandler implements CommandExecutor {
	...
	public boolean onCommand(@NotNull CommandSender sender, @NotNull Command cmd, @NotNull String label, String[] args) {
		if (args.length == 0) {
			sender.sendMessage(plugin.getChatManager().coloredRawMessage("&3This server is running &bOne in the Chamber v" + plugin.getDescription().getVersion() + " &3by&b Despical"));
